...
export const IframeScreen: React.FC<{ url: string }> = ({ url }) => {
  ...
  return (
    <div className="screen-wrapper w-full h-full grid place-items-center max-w-[1020px]">
      <div className="screen-parent relative w-full lg:w-[85%] xl:w-full aspect-[9/16] md:aspect-[4/5] lg:aspect-[8.5/10] xl:aspect-video">
        ...
        <div className="screen-slice-26 z-[26]">
          ...
          >
            <iframe
              src={url}
              className="iframe-content lg:rounded-40 border-solid md:border-8 border-transparent w-[450px] md:w-[1024px] xl:w-[1440px] aspect-[9/16] md:aspect-[4/5] lg:aspect-[8.5/10] xl:aspect-video absolute left-0 top-0"
              style={{
