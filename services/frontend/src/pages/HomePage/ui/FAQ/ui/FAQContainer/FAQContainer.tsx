...
export const FAQContainer = () => {
  return (
    <div
      className={
        " flex flex-col rounded-40 border-solid border-6 border-orange-100 w-full px-5 pt-28 text-blue-900 md:w-90 md:px-16"
      }
    >
      <div className={" flex flex-col items-end self-end w-min relative"}>
        ...
        <Message
          className={
            " border-blue-900 text-blue-900 rounded-br-none max-w-60 mt-28 lg:max-w-72 lg:text-xl"
          }
      ...
      <div className={" flex flex-col items-start self-start relative"}>
        ...
        <div className={" flex flex-col md:flex-row mt-44 mb-24"}>
          <div className={" "}>
            <Message
              className={
                " border-blue-900 text-blue-900 text-nowrap rounded-bl-none max-w-335 font-medium text-xl lg:max-w-96 lg:text-2xl"
              }
              title="Уточним, обсудим ваш проект"
            />
            <Message
              className={
                " border-blue-900 text-blue-900 rounded-bl-none max-w-64 mt-2 lg:max-w-80 lg:text-xl"
              }
            ...
            <Message
              className={
                " border-blue-900 text-blue-900 rounded-bl-none max-w-80 lg:max-w-96 mt-7 lg:text-xl"
              }
          ...
          <div
            className={
              "w-80 h-60 mt-14 md:mt-0 md:mb-28 self-center lg:w-431 lg:h-80"
            }
          >
            <img
