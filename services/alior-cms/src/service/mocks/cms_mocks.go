...
// Source: ./src/service/alior-cms.go
...
func (m *MockIBroker) Consume(ctx context.Context, queueName string, handler func(context.Context, amqp091.Delivery) error) error {
	m.ctrl.T.Helper()
...
func (m *MockIBroker) Produce(ctx context.Context, delivery amqp091.Delivery, responseBody, responseType string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Produce", ctx, delivery, responseBody, responseType)
	ret0, _ := ret[0].(error)
	return ret0
}

// Produce indicates an expected call of Produce.
func (mr *MockIBrokerMockRecorder) Produce(ctx, delivery, responseBody, responseType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Produce", reflect.TypeOf((*MockIBroker)(nil).Produce), ctx, delivery, responseBody, responseType)
}
